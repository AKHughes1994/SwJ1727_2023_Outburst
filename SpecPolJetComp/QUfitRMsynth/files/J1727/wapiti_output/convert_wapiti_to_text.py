...
def main():
    ...
    INPUT_DIR = '/home/andrewhughes/Projects/X-KAT/SwiftJ1727/new_meerkat/SpectroPol/publication_work/QU_phenom/files/J1727/wapiti_output'
    ...
    for txt_file in txt_files[:]:
        ...
        # Read the header to extract the Middle MJD
        ...
        output_file = f"{OUTPUT_DIR}/SwiftJ1727_WAPITI_{date_isot.split('T')[0].replace('-', '')}.txt"
        header = (f"# SwiftJ1727 QU data converted from WAPITI text output\n"
